...
public class FragmentFavourite extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Call<List<RetroFavourite>> call = api.getRecommendation2();
...
////            int id;
////            id = Integer.parseInt( String.valueOf( bundle.getInt("userid") ) );
//            Log.e( "TAG", "receiverid :" + id );
//
//        }

//        Log.e( "TAG", "receiverid :" + id );
//        Call<List<RetroFavourite1>> call1 = api1.getItemDetails(id);
